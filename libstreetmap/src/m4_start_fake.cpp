...
//    IntersectionIndex j = 0;
//    
//    if (steps_taken < SIGMA) {
//        
//        double best_cost = INF;
//        
//        for (auto it = legal_points.begin(); it != legal_points.end(); ++it) {
////            std::cout << it->first << std::endl;
//            if (!valid_edges[i][it->first]) {
//                double current_cost = pow(1 / find_distance_between_two_points(getIntersectionPosition(i), getIntersectionPosition(it->first)), BETA);
//                
